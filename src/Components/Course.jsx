    ...
    <div className="relative  shadow-lg mx-auto border border-[#99E4FF] rounded-lg ">
      ...
      >
        <div className="w-full  pb-3 ">
          ...
          <h2 className="text-sm lg:text-lg  font-semibold">Lorem Ipsum Dolor Sit Amet</h2>
        </div>
        <div className=" flex flex-col justify-end items-end gap-4" >
          <div className="flex gap-4 items-center  space-x-4 ml-4">
            <span className="text-gray-500 flex gap-1"><img className="w-5" src={ClockOutline} alt="" />02:00:00</span>
            <span className="text-gray-500 flex gap-1"><img className="w-5" src={ChartBarOutline} alt="" />Medium</span>
            <span className="text-gray-500 flex gap-1"><img className="w-5" src={DocumentDuplicateOutline} alt="" />{items}</span>
          ...
          <div className="flex justify-between items-center py-5 border-b border-gray-200">
            <p className="flex items-center space-x-2">
              ...
              <span>Video 1</span>
                        ...
                        <span className="text-gray-500 flex gap-1"><img className="w-5" src={ClockOutline} alt="" />10:00</span>
